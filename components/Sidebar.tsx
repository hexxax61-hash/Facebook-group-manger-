...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView }) => {
    const navItems = [
        ...
        { id: 'groups', label: 'Group Manager', icon: <UsersIcon /> },
        { id: 'publish', label: 'Post Publisher', icon: <PaperAirplaneIcon /> },
    ...
    return (
        <aside className="w-64 bg-gray-800 p-4 flex flex-col">
            <div className="flex items-center mb-10 px-2">
                ...
                <h1 className="text-xl font-bold ml-2 text-white">Social Manager</h1>
            </div>
            ...
            <div className="mt-auto">
                 <div className="flex items-center p-3 bg-gray-700/50 rounded-lg">
                    <img className="h-10 w-10 rounded-full" src="https://picsum.photos/seed/user/100/100" alt="User" />
                    <div className="ml-3">
...
const PaperAirplaneIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" /></svg>;
